...
/*:
 Change `somePlace`'s latitude to 51.514004, and the longitude to c, then print the updated values.
 */
...
favoriteBook.author = "Jones"
favoriteBook.pages = 60
favoriteBook.price = 1.50
print(favoriteBook)
